...
exports.promiseFindById = exports.verifyWrite = exports.includeRemovedThing = exports.findVersion = exports.parseCurrent = exports.resolveStorages = void 0;
...
const parseCurrent = (current) => {
    ...
    if (typeof version !== "string") {
        throw new mobiletto_orm_typedef_1.MobilettoOrmError(`expected current version as string (was ${typeof version})`);
    }
    return version;
};
exports.parseCurrent = parseCurrent;
const findVersion = (repository, id, current) => __awaiter(void 0, void 0, void 0, function* () {
    const found = (yield repository.findById(id));
    const expectedVersion = current == null ? found.version : (0, exports.parseCurrent)(current);
    // is the current version what we expected? if not, error
    if (found.version !== expectedVersion) {
        throw new mobiletto_orm_typedef_1.MobilettoOrmSyncError(id, `expected version ${expectedVersion} but found ${found.version}`);
    }
    return found;
});
