...
const repo = (storages, typeDefOrConfig) => {
    ...
    const repository = {
        ...
        opts) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const found = yield this.safeFindBy(field, value, Object.assign({}, types_js_1.FIND_FIRST, opts || {}));
        ...
        findAll(opts) {
            return __awaiter(this, void 0, void 0, function* () {
                return repository.find(Object.assign({ predicate: types_js_1.MobilettoMatchAll }, opts || {}));
            });
        },
        findAllIncludingRemoved() {
            return __awaiter(this, void 0, void 0, function* () {
                return repository.find({ predicate: types_js_1.MobilettoMatchAll, removed: true });
            });
        },
        findSingleton() {
            return __awaiter(this, void 0, void 0, function* () {
