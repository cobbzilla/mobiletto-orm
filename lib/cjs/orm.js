    ...
    const repository = {
        ...
        update(editedThing) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const found = yield (0, util_js_1.findVersion)(repository, id, (_b = editedThing === null || editedThing === void 0 ? void 0 : editedThing._meta) === null || _b === void 0 ? void 0 : _b.version);
                if (!found._meta) {
