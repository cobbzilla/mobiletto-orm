    ...
    const repository = {
        ...
        update(editedThing, current) {
            return __awaiter(this, void 0, void 0, function* () {
                if (typeof current === "undefined" || current == null) {
                    throw new mobiletto_orm_typedef_1.MobilettoOrmSyncError(editedThing.id, "update: current version is required");
                }
                // does thing with PK exist? if not, error
                const id = typeDef.id(editedThing);
                if (!id) {
                    throw new mobiletto_orm_typedef_1.MobilettoOrmSyncError(editedThing.id, "update: error determining id");
                }
                ...
                if (typeof obj.version === "undefined" || !obj.version || found.version === obj.version) {
                    obj.version = (0, mobiletto_orm_typedef_1.versionStamp)();
                }
                // remove old indexes
                const indexCleanups = [];
        ...
        remove(id, current) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return typeDef.redact(yield (0, util_js_1.verifyWrite)(repository, storages, typeDef, found.id, tombstone, found));
            });
        },
        purge(idVal) {
            return __awaiter(this, void 0, void 0, function* () {
