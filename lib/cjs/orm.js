    ...
    const repository = {
        ...
        create(thing) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (found != null) {
                    (0, mobiletto_orm_typedef_1.addError)(errors, typeDef.idFieldName(), "exists");
                }
                yield (0, util_js_1.validateIndexes)(this, obj, errors);
                obj._meta = typeDef.newMeta(id);
                return (yield (0, util_js_1.verifyWrite)(repository, storages, typeDef, id, obj, opts));
            });
        },
        update(editedThing) {
            var _a, _b;
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!((_a = editedThing === null || editedThing === void 0 ? void 0 : editedThing._meta) === null || _a === void 0 ? void 0 : _a.version)) {
                    throw new mobiletto_orm_typedef_1.MobilettoOrmError("update: _meta.version is required");
                }
                // does thing with PK exist? if not, error
                const found = yield (0, util_js_1.findVersion)(repository, id, (_b = editedThing === null || editedThing === void 0 ? void 0 : editedThing._meta) === null || _b === void 0 ? void 0 : _b.version, mobiletto_orm_typedef_1.FIND_NOREDACT);
                if (!found._meta) {
                ...
                yield (0, util_js_1.validateIndexes)(this, obj, {});
                obj._meta.version = typeDef.newVersion();
                const now = Date.now();
                obj._meta.ctime = found._meta.ctime;
                obj._meta.mtime = now;
                const toWrite = (0, mobiletto_orm_typedef_1.mergeDeep)({}, found, obj);
                return typeDef.redact(yield (0, util_js_1.verifyWrite)(repository, storages, typeDef, id, toWrite, opts, found));
            });
        },
        remove(thingToRemove) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const found = (yield (0, util_js_1.findVersion)(repository, typeDef.id(thingToRemove), (_b = thingToRemove._meta) === null || _b === void 0 ? void 0 : _b.version));
                const tombstone = typeDef.tombstone(found);
                return typeDef.redact(yield (0, util_js_1.verifyWrite)(repository, storages, typeDef, typeDef.id(found), tombstone, opts, found));
            });
        },
        purge(idVal, opts) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!force && !typeDef.isTombstone(found)) {
                    throw new mobiletto_orm_typedef_1.MobilettoOrmSyncError(id, `purge(${id}}: object must first be removed`);
                }
                const objPath = typeDef.generalPath(id);
                const deletePromises = [];
                for (const storage of yield (0, util_js_1.resolveStorages)(storages, typeDef.scope)) {
                    ...
                    if (newestJson !== JSON.stringify(f.object)) {
                        syncPromises.push(new Promise((resolve) => {
                            try {
                                ...
                                if (mobiletto_base_1.logger.isWarningEnabled()) {
        ...
        find(opts) {
            return __awaiter(this, void 0, void 0, function* () {
                let predicate = opts && opts.predicate ? opts.predicate : mobiletto_orm_typedef_1.FIND_ALL;
                if (typeof predicate !== "function") {
                    mobiletto_base_1.logger.warn(`find: opts.predicate was not a function, using FIND_ALL instead of: ${predicate}`);
                    predicate = mobiletto_orm_typedef_1.FIND_ALL;
                }
                ...
                for (const storage of yield (0, util_js_1.resolveStorages)(storages, typeDef.scope)) {
                    promises.push((0, search_js_1.search)(repository, storage, searchPath, removed, noRedact, noCollect, predicate, opts, promises, foundByHash, foundById));
                }
        ...
        findBy(field, value, opts) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (typeDef.primary && field === typeDef.primary) {
                    ...
                    const maybeRedacted = yield (0, util_js_1.redactAndApply)(typeDef, foundById, opts);
                    ...
                    for (const idxPath of idxPaths) {
                        storagePromises.push(new Promise((resolve) => {
                            if (first && addedAnything.found) {
                                ...
                                const indexLevels = typeDef.fields[field].indexLevels || mobiletto_orm_typedef_1.DEFAULT_FIELD_INDEX_LEVELS;
                                storage
                                    ...
                                    for (const entry of indexEntries) {
                                        ...
                                        if (typeof found[id] === "undefined") {
                                            found[id] = null;
                                            findByIdPromises.push((0, util_js_1.promiseFindById)(repository, storage, field, value, id, first, removed, noRedact, predicate, apply, applyResults, noCollect, found, addedAnything));
                                        }
                                    }
                ...
                if (mobiletto_base_1.logger.isDebugEnabled())
                    mobiletto_base_1.logger.debug(`findBy promise results = ${JSON.stringify(results)}`);
        ...
        safeFindFirstBy(field, value, opts) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const found = yield this.safeFindBy(field, value, Object.assign({}, mobiletto_orm_typedef_1.FIND_FIRST, opts || {}));
        ...
        findAll(opts) {
            return __awaiter(this, void 0, void 0, function* () {
                return repository.find(Object.assign({ predicate: mobiletto_orm_typedef_1.FIND_ALL }, opts || {}));
            });
        },
        findAllIncludingRemoved() {
            return __awaiter(this, void 0, void 0, function* () {
                return repository.find({ predicate: mobiletto_orm_typedef_1.FIND_ALL, removed: true });
            });
        },
        findSingleton() {
            return __awaiter(this, void 0, void 0, function* () {
                if (!typeDef.singleton) {
                    throw new mobiletto_orm_typedef_1.MobilettoOrmError(`findSingleton: typeDef ${typeDef.typeName} is not a singleton type`);
                }
...
const repositoryFactory = (storages, opts) => {
    const registry = new mobiletto_orm_typedef_1.MobilettoOrmTypeDefRegistry({
        name: (opts === null || opts === void 0 ? void 0 : opts.registryName) ? opts.registryName : `MobilettoOrmTypeDefRegistry@${(0, mobiletto_base_1.rand)(8)}`,
    });
    const factory = { storages };
    factory.repository = (typeDef) => {
        if (!typeDef.typeName) {
            throw new mobiletto_orm_typedef_1.MobilettoOrmError("typeDef.name is required");
        }
