    ...
    const repository = {
        ...
        create(thing) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return (yield (0, util_js_1.verifyWrite)(repository, storages, typeDef, id, obj));
            });
        },
        update(editedThing) {
            var _a, _b;
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return typeDef.redact(yield (0, util_js_1.verifyWrite)(repository, storages, typeDef, id, toWrite, found));
            });
        },
