...
const repo = (storages, typeDefOrConfig) => {
    ...
    const repository = {
        ...
        opts) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (typeDef.primary && field === typeDef.primary) {
                    ...
                    const maybeRedacted = noRedact ? foundById : typeDef.redact(foundById);
                        ...
                        if (first && addedAnything.found) {
                            ...
                            storage
                                ...
                                for (const entry of indexEntries) {
                                    ...
                                    if (typeof found[id] === "undefined") {
                                        found[id] = null;
                                        findByIdPromises.push((0, util_js_1.promiseFindById)(repository, storage, field, value, id, first, removed, noRedact, predicate, found, addedAnything));
                                    }
                                }
                                Promise.all(findByIdPromises)
                                    .then(() => {
        ...
        opts) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const found = yield this.safeFindBy(field, value, types_js_1.FIND_FIRST);
