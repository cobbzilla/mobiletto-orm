    ...
    const repository = {
        ...
        find(opts) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!predicate) {
                    throw new mobiletto_orm_typedef_1.MobilettoOrmError(`find: opts.predicate is required`);
                }
        ...
        findAll(opts) {
            return __awaiter(this, void 0, void 0, function* () {
                return repository.find(Object.assign({ predicate: mobiletto_orm_typedef_1.MobilettoMatchAll }, opts || {}));
            });
        },
        findAllIncludingRemoved() {
            return __awaiter(this, void 0, void 0, function* () {
                return repository.find({ predicate: mobiletto_orm_typedef_1.MobilettoMatchAll, removed: true });
            });
        },
        findSingleton() {
            return __awaiter(this, void 0, void 0, function* () {
