...
import { MobilettoOrmTypeDef, MobilettoOrmSyncError, MobilettoOrmNotFoundError, MobilettoOrmError, addError, DEFAULT_FIELD_INDEX_LEVELS, } from "mobiletto-orm-typedef";
import { FIND_FIRST, MobilettoMatchAll, } from "./types.js";
    ...
    const repository = {
        ...
        create(thing) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return (yield verifyWrite(repository, storages, typeDef, id, obj));
            });
        },
        update(editedThing) {
            var _a, _b;
