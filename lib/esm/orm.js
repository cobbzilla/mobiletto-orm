...
import { FIND_FIRST, FIND_ALL, MobilettoOrmTypeDef, MobilettoOrmSyncError, MobilettoOrmNotFoundError, MobilettoOrmError, addError, DEFAULT_FIELD_INDEX_LEVELS, } from "mobiletto-orm-typedef";
    ...
    const repository = {
        ...
        create(thing) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return (yield verifyWrite(repository, storages, typeDef, id, obj, opts));
            });
        },
        update(editedThing) {
            var _a, _b;
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return typeDef.redact(yield verifyWrite(repository, storages, typeDef, id, toWrite, opts, found));
            });
        },
        remove(thingToRemove) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return typeDef.redact(yield verifyWrite(repository, storages, typeDef, typeDef.id(found), tombstone, opts, found));
            });
        },
        purge(idVal, opts) {
            return __awaiter(this, void 0, void 0, function* () {
                            ...
                            storage
                                ...
                                for (const entry of indexEntries) {
                                    ...
                                    if (typeof found[id] === "undefined") {
                                        found[id] = null;
                                        findByIdPromises.push(promiseFindById(repository, storage, field, value, id, first, removed, noRedact, predicate, apply, applyResults, noCollect, found, addedAnything));
                                    }
                                }
