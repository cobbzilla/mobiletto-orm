...
export type MobilettoOrmRepository<T extends MobilettoOrmObject> = {
    ...
    findVersionsById: (id: MobilettoOrmIdArg, redact?: boolean) => Promise<Record<string, MobilettoOrmMetadata[]>>;
